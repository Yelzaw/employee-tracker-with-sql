...
actionsToSelect = ['View All Employees', 'Add Employee', 'Update Employee Role & Manager', 'View All Roles', 'Add Role', 'View All Departments', 'Add Department', 'View All Managers','View Employees by Department','View Total Budgets of All Departments', 'Exit'];
...
onlyEmployeeName = `SELECT id, CONCAT(first_name,' ',last_name) as name FROM employee;`;
