...
actionsToSelect = ['View All Employees', 'Add Employee', 'Update Employee Role', 'View All Roles', 'Add Role', 'View All Departments', 'Add Department', 'Exit'];
...
//                 ])
//         .then((answer2)=>{
//         const rightDept = result.find(i=>i.name === answer2.dept_id);
